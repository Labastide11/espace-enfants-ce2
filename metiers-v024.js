// Espace Enfants CE2 — Mon métier — V0.24
...
// Nouveau stockage : force une nouvelle répartition compatible V0.24.
const HISTORY_KEY = "nino_metiers_history_v2";
const CURRENT_PREFIX = "nino_metiers_week_v2_";
const FALLBACK_PHOTO = "assets/portraits/portrait_neutre.png";
const PHOTO_VERSION = "024";
...
function loadWeeklyDraw() {
  ...
  // Une répartition V0.24 valide doit toujours contenir les 12 métiers.
  const valid = draw &&
  ...
  if (!valid) {
    ...
    while (keys.length > 12) delete history[keys.shift()];
