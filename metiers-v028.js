// Espace Enfants CE2 — Mon métier — V0.28
...
function photo(prenom){const e=ELEVES.find(x=>x.prenom===prenom);return encodeURI(`assets/eleves/${e?.fichier||prenom.replace(/\s+/g,"_")+".jpg"}`)+"?v=028";}
