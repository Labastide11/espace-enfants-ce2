// Espace Enfants CE2 — Mon métier — V0.32
...
const JOBS = [
  ...
  {icon:"🦜",name:"Perroquet",banner:"assets/metiers/perroquet.png",detail:"Je reformule une consigne importante avec mes mots.",rule:"Je n’ajoute pas de nouvelle consigne."},
