// Espace Enfants CE2 — Mon métier — V0.31
const ELEVES = Array.isArray(window.NINO_ELEVES) ? window.NINO_ELEVES : [];
const STUDENTS = ELEVES.map(e => e.prenom);

const JOBS = [
  {icon:"📦",name:"Distributeur",banner:"assets/metiers/distributeur.png",detail:"Je distribue et je ramasse les cahiers, fiches et documents.",rule:"Je fais vite, calmement et sans jouer.",fixedPair:true},
